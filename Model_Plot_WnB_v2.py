...
def PlotWeighNbias(weight_layer_1, weight_layer_2, weight_layer_3, bias_layer_1, bias_layer_2, bias_layer_3, k, Trepeat, plot_show):
...
#	manager.resize(*manager.window.maxsize())
	...
	day = time.localtime()
	day_string = "%04d%02d%02d_%02d_%02d_%02d" % (day.tm_year, day.tm_mon, day.tm_mday, day.tm_hour, day.tm_min, day.tm_sec)

	plt.savefig("./01_Run_Weight_n_Bias/Model_{0:03d}-Date_{2}-TrainSeq_{1}".format(int(k+1),str(Trepeat).rjust(2,'0'),day_string), # figsize=(24, 16),
